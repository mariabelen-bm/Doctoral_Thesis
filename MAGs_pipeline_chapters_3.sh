...
coverm genome --mapper minimap2-sr --methods relative_abundance -o coverm_relative_abundance_selected.txt --bam-file-cache-directory mags_bams --interleaved /mnt/DATA/belen/MAGS_assembly_chapter4/*.pe.qc.fq.gz --genome-fasta-directory /mnt/DATA/belen/MAGS_assembly_chapter4/metawrap_refined_bins/metawrap_50_10_bins/ -x fa --threads 240
...
# Combine both files
head -n 1 /mnt/DATA/belen/MAGS_assembly_chapter4/metawrap_refined_bins/refined_checkm2_gtdb220/gtdbtk.bac120.summary.tsv > gtdbtk_summary_bac_arch.tsv
tail -n +2 /mnt/DATA/belen/MAGS_assembly_chapter4/metawrap_refined_bins/refined_checkm2_gtdb220/gtdbtk.bac120.summary.tsv >> gtdbtk_summary_bac_arch.tsv
tail -n +2 /mnt/DATA/belen/MAGS_assembly_chapter4/metawrap_refined_bins/refined_checkm2_gtdb220/gtdbtk.ar53.summary.tsv >> gtdbtk_summary_bac_arch.tsv

# Functional annotation
DRAM.py annotate -i '/mnt/DATA/belen/MAGS_assembly_chapter4/metawrap_refined_bins/metawrap_50_10_bins/*.fa' \
-o dram_annotation/ \
--min_contig_size 2000 \
--gtdb_taxonomy /mnt/DATA/belen/MAGS_assembly_chapter4/metawrap_refined_bins/refined_checkm2_gtdb220/gtdbtk_summary_bac_arch.tsv \
--checkm_quality /mnt/DATA/belen/MAGS_assembly_chapter4/refinded_checkm2/quality_report.tsv \
--threads 512 \
--verbose \
--kofam_use_dbcan2_thresholds \
--keep_tmp_dir

cd /mnt/DATA/belen/MAGS_assembly_chapter4/dram_annotation
...
metawrap quant_bins2 -a /mnt/DATA/belen/MAGS_assembly_chapter4/final.contigs.fa -o quantified_bins -t 240 -b /mnt/DATA/belen/MAGS_assembly_chapter4/metawrap_refined_bins/metawrap_50_10_bins/ /mnt/DATA/belen/MAGS_assembly_chapter4/binning_metawrap/work_files/*.bam
